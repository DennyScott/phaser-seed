...
/**
 * ArrowMovement is the class that can be attached to a game object to give it the ability to move with the arrow keys, as well
 * as the WASD keys.
 * @class ArrowMovement
 */
class ArrowMovement extends scriptBehaviour {
	...
	constructor(gameObject, speed) {
		...
		this.cursor = undefined; //Used to contain the movement variables
		this.wasd = undefined; //Used to contain WASG movement variables
	};
